...
export default function ClientLayout({ children, title, description, actions }: ClientLayoutProps) {
  ...
  // Sidebar navigation items for client portal
  const sidebarItems = [
    { icon: Home, label: "Dashboard", href: "/dashboard" },
    { icon: Building2, label: "My Investments", href: "/portfolio" },
    { icon: TrendingUp, label: "Properties", href: "/properties" },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="block text-xs text-purple-600 font-medium">Investor Portal</span>
              </div>
            </Link>
          </div>
          ...
          {user?.role === "admin" && (
            <div className="px-4 py-2">
              <Link 
                href="/admin"
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-purple-600 bg-purple-50 hover:bg-purple-100 transition-colors"
              >
          ...
          <div className="p-4 border-t border-gray-100">
            <div className="flex items-center gap-3 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 truncate">{user?.name || "Investor"}</p>
